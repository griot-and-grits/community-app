/**
 * Filter metadata from Griot & Grits
 * Source: https://github.com/griot-and-grits/gng-web/blob/main/metadata/filters.yaml
 */
...
export const TAGS: FilterItem[] = [
  { name: "Personal Stories", popularity: 1.0 },
  { name: "Resilience", popularity: 1.0 },
  { name: "Education", popularity: 1.0 },
  { name: "Family History", popularity: 0.9 },
  { name: "Historical Events", popularity: 0.9 },
  { name: "September 11", popularity: 0.8 },
  { name: "Love Stories", popularity: 0.8 },
  { name: "Founder Stories", popularity: 0.8 },
  { name: "Childhood", popularity: 0.8 },
  { name: "Philadelphia", popularity: 0.8 },
  { name: "Medical History", popularity: 0.7 },
  { name: "Racial Injustice", popularity: 0.7 },
  { name: "Heritage", popularity: 0.7 },
  { name: "Prison System", popularity: 0.6 },
  { name: "Work & Employment", popularity: 0.6 },
...
export const PEOPLE: FilterItem[] = [
  { name: "Deborah Ragan McCoy", popularity: 1.0 },
  { name: "Gladys M. Williams", popularity: 1.0 },
  { name: "Sharon McDuffie", popularity: 1.0 },
  { name: "Ty McDuffie", popularity: 1.0 },
